...
class Body(Shape):
	def __init__(self, mass, starting_x, starting_y, starting_speed_x=0.0, starting_speed_y=0.0, starting_acceleration_x=0.0, starting_acceleration_y=0.0):
		super().__init__(starting_x, starting_y)
		self.mass = mass
		self.speed_x = starting_speed_x
		self.speed_y = starting_speed_y
		self.acceleration_x = starting_acceleration_x
		self.acceleration_y = starting_acceleration_y
	...
	def updateAll(self, delta_t):
		self.updatePosition(delta_t)