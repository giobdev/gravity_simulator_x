...
def manual_input_window():
	...
	#L'area cliccabile sarà un rettangolo invisibile, in modo che si possa cliccare su ogni punto della superficie del pulsante ovale
